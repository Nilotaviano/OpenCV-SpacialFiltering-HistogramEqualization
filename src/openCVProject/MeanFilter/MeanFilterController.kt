        ...
        for (row in 0..matBefore.rows() - 2) {
            for (col in 0..matBefore.cols() - 2) {
                if (depth == 1) {
                    ...
                    val c1: DoubleArray = matBefore.get(getCorrectedIndex(row + 2, matBefore.rows()), getCorrectedIndex(col - 2, matBefore.cols()))
                    val c2: DoubleArray = matBefore.get(getCorrectedIndex(row + 2, matBefore.rows()), getCorrectedIndex(col - 1, matBefore.cols()))
                    val c3: DoubleArray = matBefore.get(getCorrectedIndex(row + 2, matBefore.rows()), getCorrectedIndex(col, matBefore.cols()))
                    val c4: DoubleArray = matBefore.get(getCorrectedIndex(row + 2, matBefore.rows()), getCorrectedIndex(col + 1, matBefore.cols()))
                    val c5: DoubleArray = matBefore.get(getCorrectedIndex(row + 2, matBefore.rows()), getCorrectedIndex(col + 2, matBefore.cols()))
                    val c6: DoubleArray = matBefore.get(getCorrectedIndex(row + 1, matBefore.rows()), getCorrectedIndex(col - 2, matBefore.cols()))
                    val c7: DoubleArray = matBefore.get(getCorrectedIndex(row + 1, matBefore.rows()), getCorrectedIndex(col - 1, matBefore.cols()))
                    val c8: DoubleArray = matBefore.get(getCorrectedIndex(row + 1, matBefore.rows()), getCorrectedIndex(col, matBefore.cols()))
                    val c9: DoubleArray = matBefore.get(getCorrectedIndex(row + 1, matBefore.rows()), getCorrectedIndex(col + 1, matBefore.cols()))
                    val c10: DoubleArray = matBefore.get(getCorrectedIndex(row + 1, matBefore.rows()), getCorrectedIndex(col + 2, matBefore.cols()))
                    val c11: DoubleArray = matBefore.get(getCorrectedIndex(row, matBefore.rows()), getCorrectedIndex(col - 2, matBefore.cols()))
                    val c12: DoubleArray = matBefore.get(getCorrectedIndex(row, matBefore.rows()), getCorrectedIndex(col - 1, matBefore.cols()))
                    val c13: DoubleArray = matBefore.get(getCorrectedIndex(row, matBefore.rows()), getCorrectedIndex(col, matBefore.cols()))
                    val c14: DoubleArray = matBefore.get(getCorrectedIndex(row, matBefore.rows()), getCorrectedIndex(col + 1, matBefore.cols()))
                    val c15: DoubleArray = matBefore.get(getCorrectedIndex(row, matBefore.rows()), getCorrectedIndex(col + 2, matBefore.cols()))
                    val c16: DoubleArray = matBefore.get(getCorrectedIndex(row - 1, matBefore.rows()), getCorrectedIndex(col - 2, matBefore.cols()))
                    val c17: DoubleArray = matBefore.get(getCorrectedIndex(row - 1, matBefore.rows()), getCorrectedIndex(col - 1, matBefore.cols()))
                    val c18: DoubleArray = matBefore.get(getCorrectedIndex(row - 1, matBefore.rows()), getCorrectedIndex(col, matBefore.cols()))
                    val c19: DoubleArray = matBefore.get(getCorrectedIndex(row - 1, matBefore.rows()), getCorrectedIndex(col + 1, matBefore.cols()))
                    val c20: DoubleArray = matBefore.get(getCorrectedIndex(row - 1, matBefore.rows()), getCorrectedIndex(col + 2, matBefore.cols()))
                    val c21: DoubleArray = matBefore.get(getCorrectedIndex(row - 2, matBefore.rows()), getCorrectedIndex(col - 2, matBefore.cols()))
                    val c22: DoubleArray = matBefore.get(getCorrectedIndex(row - 2, matBefore.rows()), getCorrectedIndex(col - 1, matBefore.cols()))
                    val c23: DoubleArray = matBefore.get(getCorrectedIndex(row - 2, matBefore.rows()), getCorrectedIndex(col, matBefore.cols()))
                    val c24: DoubleArray = matBefore.get(getCorrectedIndex(row - 2, matBefore.rows()), getCorrectedIndex(col + 1, matBefore.cols()))
                    val c25: DoubleArray = matBefore.get(getCorrectedIndex(row - 2, matBefore.rows()), getCorrectedIndex(col + 2, matBefore.cols()))
